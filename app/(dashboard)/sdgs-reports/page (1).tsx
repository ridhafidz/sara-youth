...
export default function SdgsReportsPage() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-xl font-semibold text-[#16191D]">SDGs Reports</h1>
      ...
      {loading ? (
        ...
        <>
          ...
          {filtered.length === 0 && (
            <p className="rounded-xl border border-dashed border-[#D7DBDF] px-4 py-8 text-center text-sm text-[#8A9099]">
